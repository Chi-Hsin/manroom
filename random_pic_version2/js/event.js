...
setTimeout(function(){$("#loading").hide()},2000);//加載動畫
...
// $("#origin_pic_show img").attr("draggable",true);
...
$("#chat_area").on(
  ...
  my_db.limitToLast(1).on("value",function(s)
  {//最後變動資料  一有資料寫入就會即時更新聊天室的消息顯示紀錄
